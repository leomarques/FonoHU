...
public class CorCachorro extends Fragment {
    ...
    @AfterViews
    public void aoCriar() {
        imageView.setImageResource(R.drawable.cachorro_amarelo);
        imageView2.setImageResource(R.drawable.cachorro_azul);
        imageView3.setImageResource(R.drawable.cachorro_verde);
        imageView4.setImageResource(R.drawable.cachorro_vermelho);
    ...
    public void btnSeguir() {
        ...
        getFragmentManager().beginTransaction().replace(getId(), new CorGato_()).commit();
    }
