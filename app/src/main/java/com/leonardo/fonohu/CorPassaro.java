...
public class CorPassaro extends Fragment {
    ...
    @AfterViews
    public void aoCriar() {
        imageView.setImageResource(R.drawable.passaro_amarelo);
        imageView2.setImageResource(R.drawable.passaro_azul);
        imageView3.setImageResource(R.drawable.passaro_verde);
        imageView4.setImageResource(R.drawable.passaro_vermelho);
        ...
        imagens[0] = R.drawable.passaro_amarelo;
    ...
    private void playSound() {
        ...
        if (s) {
            switch (r) {
                case 0:
                    App.inst().tocar(R.raw.aponte_o, R.raw.o_o, R.raw.passaro_o, R.raw.amarelo_o);
                    break;
                case 1:
                    App.inst().tocar(R.raw.aponte_o, R.raw.o_o, R.raw.passaro_o, R.raw.azul_o);
                    break;
                case 2:
                    App.inst().tocar(R.raw.aponte_o, R.raw.o_o, R.raw.passaro_o, R.raw.verde_o);
                    break;
                case 3:
                    App.inst().tocar(R.raw.aponte_o, R.raw.o_o, R.raw.passaro_o, R.raw.vermelho_o);
                    break;
            ...
            switch (r) {
                case 0:
                    App.inst().tocar(R.raw.aponte_a, R.raw.o_a, R.raw.passaro_a, R.raw.amarelo_a);
                    break;
                case 1:
                    App.inst().tocar(R.raw.aponte_a, R.raw.o_a, R.raw.passaro_a, R.raw.azul_a);
                    break;
                case 2:
                    App.inst().tocar(R.raw.aponte_a, R.raw.o_a, R.raw.passaro_a, R.raw.verde_a);
                    break;
                case 3:
                    App.inst().tocar(R.raw.aponte_a, R.raw.o_a, R.raw.passaro_a, R.raw.vermelho_a);
                    break;
    ...
    public void btnSeguir() {
        ...
        getFragmentManager().beginTransaction().replace(getId(), new CorPorco_()).commit();
    }
